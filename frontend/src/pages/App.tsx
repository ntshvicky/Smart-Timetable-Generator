import { CalendarDays, Download, FileSpreadsheet, LogOut, Play, ShieldCheck, Upload } from "lucide-react";
import { useEffect, useMemo, useState } from "react";
import { api, AuthError, type Cell, type Constraint, type MasterData, type Timetable } from "../api/client";
  ...
  return (
    <div className="shell">
      <aside>
        ...
        <button className="ghost" onClick={() => { localStorage.removeItem("token"); setAuth(null); }}><LogOut size={16} /> Logout</button>
      </aside>
      <main>
        <header>
          <div>
